            ...
            <div class="col-md-4 sidebar" data-aos="fade-left">
                        ...
                        <div id="carouselId" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <figure class="carousel-item active">
                                    <img src="{{  'storage/'. $post->preview_image  }}" alt="First slide">
                ...
                <div class="widget widget-post-list">
                    ...
                    <ul class="post-list">
                        ...
                        <li class="post">
                            <a href="{{ route('post.show', ['id' => $post->id])}}" class="post-permalink media">
                                <img height="46px" src="{{  'storage/'. $post->preview_image  }}" alt="blog post">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-9">
